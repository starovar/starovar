...
export default function Example() {
  ...
  <path className="draw-path" d="M401.47,147.69c.67,65-63.1,70.81-153.88,84.65-90.29,13.75-123,28.62-159.52,46.84-34.6,17.25-66.28,37.54-76.65,33.72-12.94-4.77-7.71-32.4-7.15-36.78.14-1.14.28-2.27.38-3.4,1.85-19.65,2.06-60.11-3.44-97.1C-4.52,137.16,7,99.21,105.44,95.23s152.48-23.62,193.84-48,79.73-61,92-41.91S400.79,81.6,401.47,147.69Zm-10.22-8.54c5.37-62.4,3.58-105.33-8.43-123.72s-40.18,13.8-80.77,37.3-97.82,43.18-194.39,47-105,48-99.39,85.08A359.73,359.73,0,0,1,11,270.49c-.1,1.1-.23,2.18-.38,3.28C10,278,8.56,293.65,16.19,299c8.86,6.13,32.55-13.63,67.71-27.59s70.34-28.62,159.2-43.27,142.78-26.56,148.15-89Z"/>
