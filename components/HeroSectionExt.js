...
const HeroSection = () => {
  return (
    <div id="home" className="relative overflow-hidden bg-primary pt-16">
        <div className=" lg:block inset-0 flex items-center justify-center pointer-events-none">
          ...
          <div className="w-full px-4">
            <div className="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
              ...
              <ul className="mb-10 flex gap-5 flex-wrap items-center justify-center">
                ...
                <li>
                  <Link href="https://github.com/tailgrids/play-tailwind" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 py-[14px] rounded-md bg-white/[0.12] px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark">
              ...
              <section className="transition-all duration-150 text-gray-600 dark:bg-black rounded-3xl">
	<div className="">
		<div className="flex lg:inline-flex grid-cols-4 lg:flex-wrap gap-4 justify-center lg:justify-between">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Plain HTML" className="w-14 h-14 fill-current md:mx-12 lg:m-0 text-gray-400 dark:text-neutral-200/20 hover:text-color-html5">
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Next.js" className="w-14 h-14 fill-current md:mx-12 lg:m-0 text-gray-400 dark:text-neutral-200/20 hover:text-color-nextjs">
				<title>Next.js</title>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 32" aria-label="Tailwind" className="w-14 h-14 fill-current md:mx-12 lg:m-0 text-gray-400 dark:text-neutral-200/20 hover:text-color-tailwind">
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Nuxt.js" className="w-14 h-14 fill-current md:mx-12 lg:m-0 text-gray-400 dark:text-neutral-200/20 hover:text-color-nuxtjs">
				<title>Nuxt.js</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="React" className="w-14 h-14 fill-current md:mx-12 lg:m-0 text-gray-400 dark:text-neutral-200/20 hover:text-color-react">
				<title>React</title>
