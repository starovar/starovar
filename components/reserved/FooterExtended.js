        ...
        {({ open }) => (
          <>
            <Disclosure.Button
              ...
              className={`flex justify-between transition w-full md:w-44 border dark:border-royal-black px-5 py-2.5 text-sm font-semibold dark:bg-black text-royal-lightgray rounded-md ${
                open ? 'text-royal-black md:w-44 dark:text-neutral-200 dark:border-transparent dark:bg-black' : ''
              }`}
            >
              <span>{title}</span>
              <ChevronUpIcon
